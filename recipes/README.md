RFDiffussionAA and LigandMPNN recipes for AMD GPUs.
Many thanks to Piero Coronica of the Max Planck Computing and Data Facility for developing these recipes.


Baisc tests using the examples provided with the githup repos:
